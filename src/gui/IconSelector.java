...
public class IconSelector extends ScrolledWindow {
    ...
    String iconNames[] = {
        Constants.HAND , Constants.V , Constants.I , Constants.R , Constants.C , Constants.L , Constants.SWITCH , Constants.W , Constants.AC_V  , Constants.D , Constants.ZD , Constants.LED /* , Constants.BJT_NPN ,Constants. BJT_PNP , Constants.F , Constants.G , Constants.AC_I*/ 
    };
